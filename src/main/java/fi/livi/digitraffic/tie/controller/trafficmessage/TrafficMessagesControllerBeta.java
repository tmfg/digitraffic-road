...
public class TrafficMessagesControllerBeta {
    ...
    @Operation(summary = "Traffic messages by situationId as DatexII 2.2.3")
    ...
    @ApiResponses({ @ApiResponse(responseCode = HTTP_OK,
                    ...
                    @ApiResponse(responseCode = HTTP_NOT_FOUND,
                                 ...
                                 content = @Content) })
    public ResponseEntityWithLastModifiedHeader<String> trafficMessageDatex2_223BySituationId(
            @Parameter(description = "Situation id.",
                       required = true)
            @PathVariable
            final String situationId) {
        final Pair<DataDatex2SituationMessage, Instant> situation = datex2Service.findLatestSituation(situationId, MessageTypeEnum.DATEX_2,
                Datex2Version.V_2_2_3.version);
        return ResponseEntityWithLastModifiedHeader.of(situation.getLeft().getMessage(), situation.getRight(),
                API_TRAFFIC_MESSAGE_BETA + MESSAGES + "/" + situationId + DATEX2_2_2_3);
    }

    @Operation(summary = "Traffic messages by situationId as DatexII 3.5")
    @RequestMapping(method = RequestMethod.GET,
                    produces = { APPLICATION_XML_VALUE },
    ...
    @ApiResponses({ @ApiResponse(responseCode = HTTP_OK,
                    ...
                    @ApiResponse(responseCode = HTTP_NOT_FOUND,
                                 description = "Situation id not found",
                                 content = @Content) })
    public ResponseEntityWithLastModifiedHeader<String> trafficMessageDatex2_35BySituationId(
            @Parameter(description = "Situation id.",
                       required = true)
            @PathVariable
            final String situationId) {
        final Pair<DataDatex2SituationMessage, Instant> situation =
                datex2Service.findLatestSituation(situationId, MessageTypeEnum.DATEX_2, Datex2Version.V_3_5.version);
        return ResponseEntityWithLastModifiedHeader.of(situation.getLeft().getMessage(), situation.getRight(),
                API_TRAFFIC_MESSAGE_BETA + MESSAGES + "/" + situationId + DATEX2_3_5);
    }

    @Operation(summary = "Traffic messages by situationId as json")
    @RequestMapping(method = RequestMethod.GET,
    ...
    public ResponseEntityWithLastModifiedHeader<String> trafficMessageBySituationId(
        ...
        final Pair<String, Instant> situation = datex2Service.findLatestSimppeli(situationId, includeAreaGeometry);
    ...
    public ResponseEntityWithLastModifiedHeader<String> trafficMessageHistoryBySituationId(
            ...
            @PathVariable
            final String situationId) {
        final Pair<String, Instant> situation = datex2Service.findSituationHistory(situationId);
    ...
    public ResponseEntityWithLastModifiedHeader<SituationPublication> roadworks_35(
        ...
        return ResponseEntityWithLastModifiedHeader.of(publication, publication.getPublicationTime(),
