...
public final class ApiConstants {
    ...
    private static final String LATEST = "/latest"; // Just for example for now
    ...
    public static final String API_TRAFFIC_MESSAGES_LATEST_DATEX2 = API_TRAFFIC_MESSAGES_LATEST + TRAFFIC_MESSAGES_DATEX2;
    public static final String API_TRAFFIC_MESSAGES_V1_SIMPLE = API_TRAFFIC_MESSAGES_V1 + TRAFFIC_MESSAGES_SIMPLE;
    public static final String API_TRAFFIC_MESSAGES_LATEST_SIMPLE = API_TRAFFIC_MESSAGES_LATEST + TRAFFIC_MESSAGES_SIMPLE; // Just for example for now
    ...
    public static final String API_TRAFFIC_MESSAGES_LATEST_AREA_GEOMETRIES = API_TRAFFIC_MESSAGES_LATEST + TRAFFIC_MESSAGES_AREA_GEOMETRIES;
