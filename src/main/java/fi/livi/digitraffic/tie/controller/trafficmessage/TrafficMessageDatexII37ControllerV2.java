...
@ConditionalOnProperty(prefix = "dt.trafficMessage.datex2_37", name = "enabled", havingValue = "true")
public class TrafficMessageDatexII37ControllerV2 {
    ...
    public ResponseEntityWithLastModifiedHeader<SituationPublication> trafficAnnouncements_37(
            ...
            @Parameter(description = "Bounding box") @RequestParam(required = false) final Double yMin,
            @Parameter(description = "Bounding box") @RequestParam(required = false) final Double yMax) {
        final var publication = datexIIService.findTrafficAnnouncements37(from, to, getBoundingBox(xMin, xMax, yMin, yMax));
        return ResponseEntityWithLastModifiedHeader.of(publication.getLeft(), publication.getRight(),
    ...
    public ResponseEntityWithLastModifiedHeader<SituationPublication> weightRestrictions_37(
            ...
            @Parameter(description = "Bounding box") @RequestParam(required = false) final Double yMin,
            @Parameter(description = "Bounding box") @RequestParam(required = false) final Double yMax) {
        final var publication = datexIIService.findWeightRestrictions37(from, to, getBoundingBox(xMin, xMax, yMin, yMax));
        return ResponseEntityWithLastModifiedHeader.of(publication.getLeft(), publication.getRight(),
    ...
    public ResponseEntityWithLastModifiedHeader<SituationPublication> exemptedTransports_37(
            ...
            @Parameter(description = "Bounding box") @RequestParam(required = false) final Double yMin,
            @Parameter(description = "Bounding box") @RequestParam(required = false) final Double yMax) {
        final var publication = datexIIService.findExemptedTransports37(from, to, getBoundingBox(xMin, xMax, yMin, yMax));
        return ResponseEntityWithLastModifiedHeader.of(publication.getLeft(), publication.getRight(),
