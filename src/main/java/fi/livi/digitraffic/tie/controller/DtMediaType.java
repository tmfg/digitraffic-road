...
public class DtMediaType {
    ...
    public static final String APPLICATION_JSON_VALUE = "application/json" + UTF_8_VALUE_SUFFIX;
    public static final String APPLICATION_XML_VALUE = "application/xml" + UTF_8_VALUE_SUFFIX;
