...
import fi.livi.digitraffic.tie.tms.datex2.v3_5.json.BasicDataG;
import fi.livi.digitraffic.tie.tms.datex2.v3_5.json.InformationStatusEnumG;
import fi.livi.digitraffic.tie.tms.datex2.v3_5.json.MeasuredDataPublication;
import fi.livi.digitraffic.tie.tms.datex2.v3_5.json.MeasurementOrCalculationTime;
import fi.livi.digitraffic.tie.tms.datex2.v3_5.json.MeasurementSiteTableVersionedReferenceG;
import fi.livi.digitraffic.tie.tms.datex2.v3_5.json.MeasurementSiteVersionedReferenceG;
import fi.livi.digitraffic.tie.tms.datex2.v3_5.json.Period;
import fi.livi.digitraffic.tie.tms.datex2.v3_5.json.PhysicalQuantityFault;
import fi.livi.digitraffic.tie.tms.datex2.v3_5.json.PhysicalQuantityFaultEnumG;
import fi.livi.digitraffic.tie.tms.datex2.v3_5.json.PhysicalQuantityG;
import fi.livi.digitraffic.tie.tms.datex2.v3_5.json.SinglePhysicalQuantity;
import fi.livi.digitraffic.tie.tms.datex2.v3_5.json.SiteMeasurements;
import fi.livi.digitraffic.tie.tms.datex2.v3_5.json.SiteMeasurementsIndexPhysicalQuantityG;
import fi.livi.digitraffic.tie.tms.datex2.v3_5.json.SpeedValue;
import fi.livi.digitraffic.tie.tms.datex2.v3_5.json.TimeMeaningEnumG;
import fi.livi.digitraffic.tie.tms.datex2.v3_5.json.TrafficFlow;
import fi.livi.digitraffic.tie.tms.datex2.v3_5.json.TrafficSpeed;
import fi.livi.digitraffic.tie.tms.datex2.v3_5.json.VehicleFlowValue;
