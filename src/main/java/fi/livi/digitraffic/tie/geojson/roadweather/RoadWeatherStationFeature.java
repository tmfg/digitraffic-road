...
public class RoadWeatherStationFeature {
    ...
    @ApiModelProperty(value = "Unique identifier for Road Weather Station", required = true, position = 1)
    private String id;
    ...
    @JsonInclude(JsonInclude.Include.ALWAYS)
    @ApiModelProperty(value = "Road weather station properties", required = true, position = 3)
