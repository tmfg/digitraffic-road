...
@Service
public class ForecastSectionDataUpdateService {
    private static final Logger log = LoggerFactory.getLogger(ForecastSectionDataUpdateService.class);
    ...
    @Autowired
    public ForecastSectionDataUpdateService(final ForecastSectionRepository forecastSectionRepository,
    ...
    @Transactional
    public void updateForecastSectionWeatherDataV1(final ForecastSectionDataDto data) {
        updateForecastSectionWeatherData(ForecastSectionApiVersion.V1, data);
    }

    @PerformanceMonitor(maxWarnExcecutionTime = 60000, maxErrorExcecutionTime = 80000) // normally takes between 10-50s
    @Transactional
    public void updateForecastSectionWeatherDataV2(final ForecastSectionDataDto data) {
        updateForecastSectionWeatherData(ForecastSectionApiVersion.V2, data);
    }
