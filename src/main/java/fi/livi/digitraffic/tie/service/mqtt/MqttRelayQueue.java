package fi.livi.digitraffic.tie.service.mqtt;
...
public class MqttRelayQueue {
    ...
    public enum StatisticsType {TMS, WEATHER, MAINTENANCE_TRACKING, TRAFFIC_MESSAGE, TRAFFIC_MESSAGE_DATEX, TRAFFIC_MESSAGE_SIMPLE, STATUS}
