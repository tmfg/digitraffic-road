...
public class WeatherService {
     ...
     */
    private List<WeatherSensorValueHistoryDto> mapToNaturalId(final long mapId, final Stream<SensorValueHistory> stream) {
        return stream
    ...
    private ZonedDateTime getSinceTime(final ZonedDateTime since) {
        ...
        final ZonedDateTime lastDay = ZonedDateTime.now().minusHours(24);
