...
@Schema(description = "Announcement time and duration", name = "TrafficAnnouncementV2")
...
public class TrafficAnnouncement extends JsonAdditionalProperties {
    ...
    @Schema(description = "Language of the announcement, always fi. A subset of ISO 639-1.", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull
    public TrafficAnnouncement.Language language;

    @Schema(description = "Short description about the situation", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull
    public String title;
    ...
    @Schema(description = "Name of the sender", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull
    ...
    public enum EarlyClosing {
        ...
        EarlyClosing(final String value) {
            this.value = value;
        }
