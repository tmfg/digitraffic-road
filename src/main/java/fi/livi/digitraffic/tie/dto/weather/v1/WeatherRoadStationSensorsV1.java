...
public class WeatherRoadStationSensorsV1 extends RoadStationSensorsDtoV1<RoadStationSensorDtoV1> {

    public WeatherRoadStationSensorsV1(final Instant lastUpdated, final Instant dataLastCheckedTime, final List<RoadStationSensorDtoV1> roadStationSensors) {
