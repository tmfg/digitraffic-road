...
public class ForecastSectionFeatureV1 extends FeatureV1<MultiLineString, ForecastSectionPropertiesV1> {

    @Schema(description = ForecastSectionPropertiesV1.ID_DESC)
    public final String id;

    public ForecastSectionFeatureV1(final MultiLineString geometry, final ForecastSectionPropertiesV1 properties) {
