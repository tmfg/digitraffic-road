...
public class MaintenanceRealizationTaskOperation {
    ...
    public MaintenanceRealizationTaskOperation(final long id, final String fi, final String sv, final String en) {
        this.id = id;
        this.fi = fi;
        this.sv = sv;
        this.en = en;
