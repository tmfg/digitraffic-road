...
public abstract class AbstractLamStationAttributeUpdater extends AbstractRoadStationUpdater {
    ...
    public AbstractLamStationAttributeUpdater(final RoadStationService roadStationService) {
