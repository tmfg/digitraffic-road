...
public class TravelTimeMediansUpdateJob extends SimpleUpdateJob {
    ...
    protected void doExecute(final JobExecutionContext context) throws Exception {
        ...
        final long between = ChronoUnit.MINUTES.between(from, now.minusMinutes(5));
    ...
    private ZonedDateTime getStartTime(final MetadataUpdated updated, final ZonedDateTime now) {
