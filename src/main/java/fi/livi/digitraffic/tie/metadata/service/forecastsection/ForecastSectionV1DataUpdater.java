...
@Service
public class ForecastSectionV1DataUpdater {

    private static final Logger log = LoggerFactory.getLogger(ForecastSectionV1DataUpdater.class);
    ...
    @Autowired
    public ForecastSectionV1DataUpdater(final ForecastSectionClient forecastSectionClient, final ForecastSectionRepository forecastSectionRepository) {
    ...
    public Instant updateForecastSectionWeatherData() {
        final ForecastSectionDataDto data = forecastSectionClient.getRoadConditionsV1();
