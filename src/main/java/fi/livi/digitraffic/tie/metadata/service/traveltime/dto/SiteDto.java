...
public class SiteDto {
    ...
    public String toString() {
        return new ToStringBuilder(this)
            ...
            .append("names", names)
            .append("roadNumber", roadNumber)
            .append("roadRegisterAddress", roadRegisterAddress)
            .append("coordinatesKkj3", coordinatesKkj3)
            .append("coordinatesWgs84", coordinatesWgs84)
            .toString();
    }
}
