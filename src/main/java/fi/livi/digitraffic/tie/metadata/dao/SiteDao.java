...
public class SiteDao {
    ...
    public void createOrUpdateSite(final long siteNaturalId, final String nameFi, final String nameSv, final String nameEn,
                                   final int roadNumber, final int roadSectionNumber, final int roadSectionBeginDistance,
                                   final Long xCoordKkj3, final Long yCoordKkj3,
        ...
        args.put("roadSectionBeginDistance", roadSectionBeginDistance);
        ...
        jdbcTemplate.update(
            "MERGE INTO SITE s " +
                ...
                "INSERT (natural_id, name_fi, name_sv, name_en, road_section_id, road_section_begin_distance, x_coord_kkj3, y_coord_kkj3, longitude_wgs84, latitude_wgs84, obsolete_date) " +
                "VALUES (:naturalId, :nameFi, :nameSv, :nameEn, " +
                    ...
                    ":roadSectionBeginDistance, :xCoord, :yCoord, :longitude, :latitude, null) " +
                "WHEN MATCHED THEN " +
                "UPDATE SET s.name_fi = :nameFi, s.name_sv = :nameSv, s.name_en = :nameEn, " +
                    ...
                    "road_section_begin_distance = :roadSectionBeginDistance, s.x_coord_kkj3 = :xCoord, s.y_coord_kkj3 = :yCoord, " +
                    "s.longitude_wgs84 = :longitude, s.latitude_wgs84 = :latitude, s.obsolete_date = null",
                args);
    }
