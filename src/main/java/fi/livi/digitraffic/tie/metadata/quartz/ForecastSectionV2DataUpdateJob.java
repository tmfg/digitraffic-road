...
public class ForecastSectionV2DataUpdateJob extends SimpleUpdateJob {
    ...
    protected void doExecute(JobExecutionContext context) {
        final Instant messageTimestamp = forecastSectionDataUpdater.updateForecastSectionWeatherData(2);

        dataStatusService.updateDataUpdated(DataType.FORECAST_SECTION_V2_WEATHER_DATA, DateHelper.toZonedDateTime(messageTimestamp));
    }
}
