...
@Entity
public class V2WorkMachine {

    @Id
    @GenericGenerator(name = "SEQ_V2_WORK_MACHINE", strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
                      parameters = @Parameter(name = "sequence_name", value = "SEQ_V2_WORK_MACHINE"))
    @GeneratedValue(generator = "SEQ_V2_WORK_MACHINE")
    private Long id;
    ...
    public V2WorkMachine() {

    }

    public V2WorkMachine(final long harjaId, final long harjaUrakkaId, final String type) {
