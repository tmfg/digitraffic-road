...
import fi.livi.digitraffic.tie.lotju.xsd.datex2.AuthorityOperation;
import fi.livi.digitraffic.tie.lotju.xsd.datex2.CarParks;
import fi.livi.digitraffic.tie.lotju.xsd.datex2.Conditions;
import fi.livi.digitraffic.tie.lotju.xsd.datex2.ConstructionWorks;
import fi.livi.digitraffic.tie.lotju.xsd.datex2.DisturbanceActivity;
import fi.livi.digitraffic.tie.lotju.xsd.datex2.EnvironmentalObstruction;
import fi.livi.digitraffic.tie.lotju.xsd.datex2.EquipmentOrSystemFault;
import fi.livi.digitraffic.tie.lotju.xsd.datex2.GeneralInstructionOrMessageToRoadUsers;
import fi.livi.digitraffic.tie.lotju.xsd.datex2.GeneralNetworkManagement;
import fi.livi.digitraffic.tie.lotju.xsd.datex2.GeneralObstruction;
import fi.livi.digitraffic.tie.lotju.xsd.datex2.GenericSituationRecord;
import fi.livi.digitraffic.tie.lotju.xsd.datex2.InfrastructureDamageObstruction;
import fi.livi.digitraffic.tie.lotju.xsd.datex2.MaintenanceWorks;
import fi.livi.digitraffic.tie.lotju.xsd.datex2.NonWeatherRelatedRoadConditions;
import fi.livi.digitraffic.tie.lotju.xsd.datex2.PoorEnvironmentConditions;
import fi.livi.digitraffic.tie.lotju.xsd.datex2.PublicEvent;
import fi.livi.digitraffic.tie.lotju.xsd.datex2.ReroutingManagement;
import fi.livi.digitraffic.tie.lotju.xsd.datex2.RoadConditions;
import fi.livi.digitraffic.tie.lotju.xsd.datex2.RoadOperatorServiceDisruption;
import fi.livi.digitraffic.tie.lotju.xsd.datex2.RoadOrCarriagewayOrLaneManagement;
import fi.livi.digitraffic.tie.lotju.xsd.datex2.RoadsideAssistance;
import fi.livi.digitraffic.tie.lotju.xsd.datex2.RoadsideServiceDisruption;
import fi.livi.digitraffic.tie.lotju.xsd.datex2.SignSetting;
import fi.livi.digitraffic.tie.lotju.xsd.datex2.SituationRecord;
import fi.livi.digitraffic.tie.lotju.xsd.datex2.SpeedManagement;
import fi.livi.digitraffic.tie.lotju.xsd.datex2.TransitInformation;
import fi.livi.digitraffic.tie.lotju.xsd.datex2.VehicleObstruction;
import fi.livi.digitraffic.tie.lotju.xsd.datex2.WeatherRelatedRoadConditions;
import fi.livi.digitraffic.tie.lotju.xsd.datex2.WinterDrivingManagement;
...
public enum Datex2SituationRecordType {
    ...
    private static final Logger log = LoggerFactory.getLogger(Datex2SituationRecordType.class);
