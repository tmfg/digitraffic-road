...
public class ImsDatex2JmsMessageListenerTest extends AbstractJmsMessageListenerTest {
    ...
    public void datex2ReceiveImsMessagesV1_2_0JsonV0_2_4() throws IOException {
        ...
        checkOneActiveSituation(SITUATION_ID_1);
    }
    ...
    private void checkOneActiveSituation(final String situationIdToFind) {
        ...
        assertEquals(situationIdToFind, situations.get(0).getId());
        ...
        assertEquals(situationIdToFind, activeJson.getFeatures().get(0).getProperties().situationId);
    }
