...
public class RegionGeometryUpdateJobTestHelper {

    private final RegionGeometryUpdateJob regionGeometryUpdateJob;
    private final JobExecutionContext jobExecutionContext;

    public RegionGeometryUpdateJobTestHelper(final RegionGeometryGitClient regionGeometryGitClient, final RegionGeometryUpdateService regionGeometryUpdateService, final DataStatusService dataStatusService) {
        ...
        ReflectionTestUtils.setField(regionGeometryUpdateJob, "regionGeometryUpdateService", regionGeometryUpdateService);
