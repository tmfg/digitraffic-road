...
public class TmsStationMetadataWebServiceV1Test extends AbstractWebServiceTest {
    ...
    @Autowired
    private TmsStationMetadataWebServiceV1 tmsStationService;
    ...
    public void findAllPublishableTmsStationsAsFeatureCollection() {
        final TmsStationFeatureCollectionSimpleV1 stations = tmsStationService.findAllPublishableTmsStationsAsSimpleFeatureCollection(false, ACTIVE);
    ...
    public void findAllPublishableTmsStationsAsFeatureCollectionOnlyUpdateInfo() {
        final TmsStationFeatureCollectionSimpleV1 stations = tmsStationService.findAllPublishableTmsStationsAsSimpleFeatureCollection(true, ACTIVE);
    ...
    public void findPermanentlyRemovedStations() {
        final TmsStationFeatureCollectionSimpleV1 stations = tmsStationService.findAllPublishableTmsStationsAsSimpleFeatureCollection(false, REMOVED);
    ...
    public void findAllStations() {
        final TmsStationFeatureCollectionSimpleV1 stations = tmsStationService.findAllPublishableTmsStationsAsSimpleFeatureCollection(false, ALL);
    ...
    public void getTmsStationByRoadStationId() {
        final TmsStationFeatureDetailedV1 tmsStation = tmsStationService.getTmsStationById(rsNaturalId);
