...
public class RoadWeatherStationMetadataRestTest extends MetadataRestTest {
    ...
    public void testRoadWeatherStationMetadataRestApi() throws Exception {
        mockMvc.perform(get(MetadataApplicationConfiguration.API_V1_BASE_PATH + MetadataApplicationConfiguration.API_METADATA_PART_PATH + "/road-weather-stations"))
                ...
                .andExpect(jsonPath("$.features[0].properties.collectionInterval", Matchers.isA(Integer.class)))
                ...
                .andExpect(jsonPath("$.features[0].properties.names.fi", is("Tie 9 Jämsä")))
                .andExpect(jsonPath("$.features[0].properties.names.sv", is("Väg 9 Jämsä")))
                .andExpect(jsonPath("$.features[0].properties.names.en", is("Road 9 Jämsä")))
                .andExpect(jsonPath("$.features[0].properties.roadPart", is(226)))
                .andExpect(jsonPath("$.features[0].properties.roadNumber", is(9)))
                .andExpect(jsonPath("$.features[0].properties.sensors", Matchers.hasSize(3)))
