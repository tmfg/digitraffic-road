...
public class RoadStationStatusesUpdateJobIntegrationTest extends AbstractMetadataIntegrationTest {

    private static final Logger log = LoggerFactory.getLogger(RoadStationStatusesUpdateJobIntegrationTest.class);
