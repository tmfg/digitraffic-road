...
public class RoadStationStatusDataRestTest extends RestTest {
    ...
    public void testRoadStatusDataRestApi() throws Exception {
        mockMvc.perform(get(MetadataApplicationConfiguration.API_V1_BASE_PATH +
                ...
                .andExpect(jsonPath("$.roadStationStatusData[0].conditionCode", Matchers.notNullValue()))
                .andExpect(jsonPath("$.roadStationStatusData[0].conditionUpdatedUtc", Matchers.notNullValue()))
                .andExpect(jsonPath("$.roadStationStatusData[0].conditionUpdatedLocalTime", Matchers.notNullValue()))
