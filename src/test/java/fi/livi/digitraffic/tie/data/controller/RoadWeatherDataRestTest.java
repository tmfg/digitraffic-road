...
public class RoadWeatherDataRestTest extends RestTest {
    ...
    public void testRoadWeatherDataRestApi() throws Exception {
        mockMvc.perform(get(MetadataApplicationConfiguration.API_V1_BASE_PATH +
                ...
                .andExpect(jsonPath("$.roadWeatherData[0].roadStationId", Matchers.notNullValue()))
                .andExpect(jsonPath("$.roadWeatherData[0].sensorValues", Matchers.notNullValue()))
                .andExpect(jsonPath("$.roadWeatherData[0].sensorValues[0].sensorName", Matchers.isA(String.class)))
                .andExpect(jsonPath("$.roadWeatherData[0].sensorValues[0].sensorId", Matchers.isA(Integer.class)))
