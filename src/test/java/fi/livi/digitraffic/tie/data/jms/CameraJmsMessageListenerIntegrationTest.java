...
import fi.livi.digitraffic.tie.data.sftp.AbstractSftpIntegrationTest;
    ...
    public void testPerformanceForReceivedMessages() throws IOException, JAXBException, DatatypeConfigurationException {
        ...
        while (testBurstsLeft > 0) {
            ...
            while (true && presetIterator.hasNext()) {
                ...
                cameraJmsMessageListener.onMessage(AbstractJmsMessageListenerIntegrationTest.createTextMessage(xmlSW.toString(), "Kuva " + preset.getPresetId()));
